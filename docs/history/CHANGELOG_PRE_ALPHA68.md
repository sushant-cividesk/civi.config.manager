# Configuration Manager changelog archive

This file preserves development history older than Alpha68. It was split from the root changelog to keep the active release history concise; no historical entry was intentionally rewritten.
